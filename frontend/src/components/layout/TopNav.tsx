    ...
    <nav className="navbar d-none d-lg-block">
      <div className="container">
        ...
        <div className="navbar-nav">
          ...
          <NavLink to="/settings" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`} title={errors > 0 ? `Settings (${analysisErrorLabel(errors)})` : 'Settings'} style={{ position: 'relative' }}>
            <AnalysisErrorBadge count={errors} style={{ top: 4, right: 4 }} />
